...
/* Define to 1 if you have the <openssl/tls.h> header file. */
/* #undef HAVE_OPENSSL_TLS_H */
...
/* disable HTTPS_OPENSSL support */
#define HTTPS_OPENSSL_SUPPORT 1
...
#define PACKAGE_STRING "libmicrohttpd 0.9.43"
